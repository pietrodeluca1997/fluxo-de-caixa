    ...
    public static class DocumentationConfiguration
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(swaggerOptions =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Cash Flow Account API",
                    Description = "An API responsible for all functionality related to account management.",
        ...
        public static void UseSwaggerDocumentation(this IApplicationBuilder appBuilder)
        {
            ...
            {
                swaggerOptions.SwaggerEndpoint(swaggerEndpoint, "CF.Account.API v1");
